                    ...
                    <p class="page-section">
                        <div>
                            ...
                            <p>
                                ...
                                challeges and the enterprise faces the refactoring approach dilemma: a "Big-bang" approach or an incremental refactoring. A so-called "Big-bang" approach focuses all efforts with the refactoring of the monolith, 
                                ...
                                The refactoring phase slowly transforms the monolith into a cloud-native applicaction which takes full advantage of cloud features, by coding in new programming languages and applying modern architectural patterns. 
                            ...
                            <p>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <b>Service discovery and load balancing</b> - Containers receive IP addresses from Kubernetes, while it assigns a single Domain Name System (DNS) name to a set of containers to aid in load-balancing requests across the cointainers of the set. 
                                    </li>
                                </ul>
                            ...
                            <p>
                                ...
                                <p>
                                    ...
                                    <img src="img/stackedEtcdTopology.PNG" class="responsive" alt="">
                                    For data store isolation from the control plane components, the bootstrapping process can be configured for an external etcd topology, where the data store is provisioned on a dedicated separate host, thus reducing the chances of an etcd failure.
                                    <img src="img/externaletcdTopology.PNG" class="responsive" alt="">
